...
#define SCMI_PINCTRL_ATTR_NUM_ELEM(n) ((n) & GENMASK(15, 0))
...
#define SCMI_PINCTRL_ASSOC_REM(n) (((n) << 16) & GENMASK(31, 16))
#define SCMI_PINCTRL_ASSOC_RET(n) ((n) & GENMASK(11, 0))
...
#define SCMI_PINCTRL_CFGG_FLAG(attr)     (((attr) & GENMASK(19, 18)) >> 18)
#define SCMI_PINCTRL_CFGG_ONE            0
#define SCMI_PINCTRL_CFGG_ALL            1
#define SCMI_PINCTRL_CFGG_ONLY_FUNC      2
#define SCMI_PINCTRL_CFGG_SEL_TYPE(attr) (((attr) & GENMASK(17, 16)) >> 16)
#define SCMI_PINCTRL_CFGG_SKIP(attr)     (((attr) & GENMASK(15, 8)) >> 8)
#define SCMI_PINCTRL_CFGG_TYPE(attr)     ((attr) & GENMASK(7, 0))
...
#define SCMI_PINCTRL_CFG_NUM(attr)      (((attr) & GENMASK(9, 2)) >> 2)
#define SCMI_PINCTRL_CFG_SEL_TYPE(attr) ((attr) & GENMASK(1, 0))
...
#define SCMI_PINCTRL_REQ_SEL_TYPE(attr) ((attr) & GENMASK(1, 0))
...
#define SCMI_PINCTRL_REL_SEL_TYPE(attr) ((attr) & GENMASK(1, 0))
