...
const char *plat_scmi_pd_get_name(unsigned int agent_id,
				  unsigned int pd_id);

unsigned int plat_scmi_pd_statistics(unsigned int agent_id,
				     unsigned long *pd_id);

unsigned int plat_scmi_pd_get_attributes(unsigned int agent_id,
					 unsigned int pd_id);
